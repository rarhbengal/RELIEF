...
map.getView().fit([9301379.443091, 2446695.354868, 10036272.012569, 2895531.314160], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">RELIEF CHARACTERIZATION</h2>';
        return titleElement;
    })(),
